      ...
      <div className="container py-8">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/" className="text-sm hover:text-purple-500">
              Home
            </Link>
            <Link href="/about" className="text-sm hover:text-purple-500">
              About Us
            </Link>
            <Link href="/services" className="text-sm hover:text-purple-500">
              Services
            </Link>
            <Link href="/contact" className="text-sm hover:text-purple-500">
              Contact Us
            </Link>
          </div>
        ...
        <div className="text-center text-sm text-gray-500">
          Copyright © Brands.io {new Date().getFullYear()}
        </div>
      </div>
    </footer>
  );

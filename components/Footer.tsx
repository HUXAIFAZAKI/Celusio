...
import Celusio from "@/public/Celusio.png";
  ...
  return (
    <footer className="border-t bg-gray-50">
      <div className="container px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="max-w-md mx-auto flex flex-col sm:flex-row gap-4">
            <Input
              ...
              className="bg-black text-white placeholder:text-gray-400 focus:ring-2 focus:ring-purple-500 focus:outline-none border-gray-300"
            />
          ...
          {/* <div className="flex justify-center items-center space-x-2">
            ...
            <Link
              href="#"
              className="text-sm text-purple-500 hover:underline hover:text-purple-600"
            >
              Watch our video
            </Link>
          </div> */}
        ...
        {/* Middle Section: Logo, Navigation, and Social Media */}
        <div className="flex flex-col md:flex-row justify-between items-center mt-12 space-y-8 md:space-y-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-semibold text-gray-900">Celusio</span>
          </div>
        ...
        <div className="text-center text-sm text-gray-500 mt-8 pt-8 border-t border-gray-200">
          Copyright © Celusio {new Date().getFullYear()}
        </div>
      </div>
    </footer>
  );
